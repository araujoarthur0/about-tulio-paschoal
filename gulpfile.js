...
gulp.task('copy-vendor', gulp.series(function () {
    return gulp.src(vendor.css, { cwd: './node_modules/', base: './node_modules/' }).pipe(gulp.dest('./dist/css/'));
}, function () {
    return gulp.src(vendor.js, { cwd: './node_modules/', base: './node_modules/' }).pipe(gulp.dest('./dist/js/'));
}));
